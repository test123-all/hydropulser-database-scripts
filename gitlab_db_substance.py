...
spec_gas_const = SUBSTANCES[air_id + "/R"]
...
therm_conduct = SUBSTANCES[air_id + "/lambda"]
...
isentropic_exp = SUBSTANCES[air_id + "/gamma"]
...
spec_heat_cap_const_p = SUBSTANCES[air_id + "/cp"]
...
spec_heat_cap_const_v = SUBSTANCES[air_id + "/cv"]
...
path = "C:/Users/NP/Documents/AIMS/datasheets-mockup/substances/" + air_id + "/"
print(data.g.serialize(destination=path + "rdf.json", format="json-ld", auto_compact=True))
print(data.g.serialize(destination=path + "rdf.ttl", base=SUBSTANCES, format="longturtle"))
print(data.g.serialize(destination=path + "rdf.xml", base=SUBSTANCES, format="xml"))
